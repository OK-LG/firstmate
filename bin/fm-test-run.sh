...
family_for_basename() {
  case "$1" in
    ...
    fm-kimi-harness.test.sh|fm-muse-harness.test.sh|fm-rovo-harness.test.sh|fm-agy-harness.test.sh|fm-omp-harness.test.sh|fm-zcode-harness.test.sh|fm-herdr-lab.test.sh|fm-lint.test.sh|\
    ...
    fm-muse-signals-live-e2e.test.sh|fm-rovo-signals-live-e2e.test.sh|fm-agy-signals-live-e2e.test.sh|fm-zcode-signals-live-e2e.test.sh|fm-zcode-primary-live-e2e.test.sh|\
    fm-herdr-version-floor-live-e2e.test.sh|\
    fm-herdr-pi-stale-registration-live-e2e.test.sh|\
    fm-zcode-herdr-bridge-live-e2e.test.sh|\
...
tests/fm-zcode-harness.test.sh 20000
...
families_for_changed_path() {
  ...
  case "$path" in
    ...
    bin/fm-quota-choose.sh)
      printf '%s\n' "__script__:fm-quota-choose.test.sh"
      ;;
    bin/fm-zcode-turnend-hook.sh)
      printf '%s\n' "__script__:fm-zcode-harness.test.sh"
      ;;
